...
styledWordClasses:
    [
        ...
        "md:text-5xl font-bold",
        "md:text-5xl font-extrabold text-green-400",
        "md:text-5xl font-bold",
        "md:text-5xl font-bold text-red-400",
...
<img src="/mod-on-twitch/show-mod-icons.png" alt="Show Mod Icons Screenshot" width="300" height="311" />

Open Twitch chat -> Click on the gear icon next to the Chat button -> Switch to Mod Settings -> Show Mod Icons.

<img src="/mod-on-twitch/mod-icons-chat.png" alt="Mod Icons" width="300" height="75" />
...
<a href="https://dashboard.twitch.tv/settings/moderation/shared-bans" target="_blank">Twitch Dashboard Share Ban Info</a>
